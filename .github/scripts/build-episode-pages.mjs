...
<!-- Google Analytics (GA4) — Consent Mode v2: ingen cookies før samtykke gis i banneret (assets/consent.js) -->
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
var hcStored = null;
try { hcStored = localStorage.getItem('hc-consent-analytics'); } catch (e) {}
gtag('consent', 'default', {
  analytics_storage: hcStored === 'granted' ? 'granted' : 'denied',
  ad_storage: 'denied',
  ad_user_data: 'denied',
    ...
    <div class="ds-footer__grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="mailto:podcast@hegechristine.no">Kontakt</a></li>
        </ul>
      </div>
      <div>
        <h5>Følg</h5>
        <ul>
          <li><a href="https://www.instagram.com/theeditpodcast/" target="_blank" rel="noopener">Instagram</a></li>
...
(function(){
  ...
  form.addEventListener('submit', function(e){
    ...
    try {
      k.submit();
      setTimeout(function(){
        if (typeof gtag === 'function') gtag('event', 'nyhetsbrev_pamelding', { kilde: 'podcast_episode' });
...
<!-- Cloudflare Web Analytics --><script defer src='https://static.cloudflareinsights.com/beacon.min.js' data-cf-beacon='{"token": "23ddf51c04ba4d6597c41ee0e86c252a"}'></script><!-- End Cloudflare Web Analytics -->
